...
import com.rsetiapp.databinding.FragmentSettlementVeryficationFormBinding
import kotlinx.coroutines.launch
import java.io.ByteArrayOutputStream
import java.util.Locale

//
class SettlementVeryficationFormFragment :
    BaseFragment<FragmentSettlementVeryficationFormBinding>(FragmentSettlementVeryficationFormBinding::inflate) {

    private val commonViewModel: CommonViewModel by activityViewModels()
    private lateinit var CandidateSettlement: CandidateSettlementVerificationDetail
    var current_latitude: Double = 0.0
    var current_longitude: Double = 0.0
    var current_accuracy: Double = 0.0
    var old_latitude: Double = 0.0
    var old_longitude: Double = 0.0
    var old_accuracy: Double = 0.0
    var altitude: Double = 0.0
    var accuracy_add: Double = 0.0
    var dynamic_accuracy: Double = 0.0
...
//        }
        ...
        binding.tvCareOfName.text = CandidateSettlement.guardianName
        binding.tvContactName.text = CandidateSettlement.mobileNo
...
//                            batchId = CandidateSettlement.batchId.toString(),
//                            candidateId = CandidateSettlement.candidateId ?: "",
//                            mobileNo = CandidateSettlement.mobileNo ?: "",
//                            guardianName = CandidateSettlement.guardianName ?: "",
//                            guardianMobileNo = CandidateSettlement.guardianNo ?: "",
//                            candidatePhoto = CandidateSettlement.candidateProfilePic ?: "",
//                            quarterOne = CandidateSettlement.quarter1 ?: "",
//                            quarterTwo = CandidateSettlement.quarter2 ?: "",
//                            quarterThree = CandidateSettlement.quarter3 ?: "",
//                            quarterFour = CandidateSettlement.quarter4 ?: "",
//                            quarterFive = CandidateSettlement.quarter5 ?: "",
//                            quarterSix = CandidateSettlement.quarter6 ?: "",
//                            quarterSeven = CandidateSettlement.quarter7 ?: "",
//                            quarterEight = CandidateSettlement.quarter8 ?: "",
...
//    val quarterEight: Int?,
                        FollowUpInsertReq(AppUtil.getAndroidId(requireContext()),userPreferences.getUseID(),
                            ...
                            mobileNo = CandidateSettlement.mobileNo ?: "",
                            guardianName = CandidateSettlement.guardianName ?: "",
                            guardianMobileNo = CandidateSettlement.guardianMobileNo?:"",
                            candidatePhoto = "",
                            quarterOne = "",
                            quarterTwo = "",
                            quarterThree =  "",
                            ...
                            appointmentLetter = appointmentLetter,
                            salaryRange = "",
                            settlementReason = settlementPhoto,AppUtil.getSavedEntityPreference(requireContext()), AppUtil.getSavedOrgIdPreference(requireContext()),AppUtil.getSavedHRIdPreference(requireContext())
...
// 🔹 Previous saved location (from candidate / DB / preference)
//                    val previousLat = AppUtil.getLastLatitude(requireContext())?.toDoubleOrNull()
//                    val previousLng = AppUtil.getLastLongitude(requireContext())?.toDoubleOrNull()
// 🔹 Current GPS location
                    val currentLat = latitude
                    val currentLng = longitude

// 🔹 Validate accuracy (20% max)
